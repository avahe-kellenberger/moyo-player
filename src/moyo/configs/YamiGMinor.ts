...
export default class YamiGMinor implements DrumConfig {
  public readonly scaleName: string = 'Yami G Minor'
  public readonly imagePath: string = Assets.RED_YAMI
  public readonly tongues: DrumTongue[] = [
    new DrumTongue('3_g', new Polygon([
      [255, 374],
      [205, 304],
      [202, 276],
      [215, 246],
    ...
    new DrumTongue('3_a_sharp', new Polygon([
      [47, 303],
      [101, 243],
      [120, 235],
      [144, 238],
    ...
    new DrumTongue('4_f', new Polygon([
      [306, 55],
      [285, 107],
      [262, 121],
      [237, 121],
