...
export class Tones {
    ...
    private static loadTones(): Map<Note, Howl> {
        ...
        toneMap.set('mid_a_sharp', new Howl({ src: [`${Assets.SOUNDS_PATH}/mid_a_sharp.mp3`], volume: 0.32 }))
        ...
        toneMap.set('mid_c_sharp', new Howl({ src: [`${Assets.SOUNDS_PATH}/mid_c_sharp.mp3`], volume: 0.32 }))
        toneMap.set('mid_d', new Howl({ src: [`${Assets.SOUNDS_PATH}/mid_d.mp3`], volume: 0.32 }))
        toneMap.set('mid_d_sharp', new Howl({ src: [`${Assets.SOUNDS_PATH}/mid_d_sharp.mp3`], volume: 0.32 }))
        toneMap.set('mid_e', new Howl({ src: [`${Assets.SOUNDS_PATH}/mid_e.mp3`], volume: 0.32 }))
        toneMap.set('mid_f_sharp', new Howl({ src: [`${Assets.SOUNDS_PATH}/mid_f_sharp.mp3`], volume: 0.32 }))
        ...
        toneMap.set('high_f_sharp', new Howl({ src: [`${Assets.SOUNDS_PATH}/high_f_sharp.mp3`], volume: 0.32 }))
